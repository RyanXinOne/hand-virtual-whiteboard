...
def run():
    ...
    parser.add_argument("--pretrained_weights", type=str, default="checkpoints/yolov3_ckpt_40_map0.87006.pth", help="Path to checkpoint file (.weights or .pth). Starts training from checkpoint model")
    parser.add_argument("--pretrained_epochs", type=int, default=40, help="Number of epochs already trained. Used to determine the epoch number in the checkpoint filename.")
